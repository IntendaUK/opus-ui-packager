...
const fmComponent = new FuzzyMatcher(['id', 'type', 'prps', 'wgts', 'scope', 'relId', 'traits', 'trait', 'traitPrps', 'container', 'auth', 'comment', 'condition', 'comments', 'static', 'pure']);
const fmTrait = new FuzzyMatcher(['acceptPrps', 'traitConfig', 'id', 'type', 'prps', 'wgts', 'scope', 'relId', 'traits', 'trait', 'traitPrps', 'container', 'auth', 'comment', 'condition', 'comments', 'static', 'pure']);
const fmComponentInsideRowMda = new FuzzyMatcher(['rowPrps', 'id', 'type', 'prps', 'wgts', 'scope', 'relId', 'traits', 'trait', 'traitPrps', 'container', 'auth', 'comment', 'condition', 'comments', 'static', 'pure']);
const fmComponentPopoverMda = new FuzzyMatcher(['position', 'popoverZIndex', 'id', 'type', 'prps', 'wgts', 'scope', 'relId', 'traits', 'trait', 'traitPrps', 'container', 'auth', 'comment', 'condition', 'comments', 'static', 'pure']);
